...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Automation\YP_Automation_Python\Sprint_4.2'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Automation\YP_Automation_Python\Sprint_4.2\Scripts\deactivate.nu'
